...
protected:
    ...
    virtual cg::static_infer::ValueInferDesc mixin_get_static_infer_desc(
            OperatorNodeBase& opr);
...
protected:
    ...
    void init_rt_force_dynamic_mem_alloc_imply_chain() override {
        mixin::init_rt_force_dynamic_mem_alloc_imply_chain_for_dyn_pass_i2o(*this);
    }
};
...
protected:
    ...
    void rofwd_init_mem_plan() { this->mixin_rofwd_init_mem_plan(*this); }

    void rofwd_execute() { this->mixin_rofwd_execute(*this); }
};
 ...
 */
MGB_DEFINE_CLS_WITH_SUPER(
        ForwardInputToOutput, cg::SingleCNOperatorNodeBase,
        public mixin::ForwardInputToOutput) // {
    void scn_do_execute() override final { mixin_scn_do_execute(*this); }
