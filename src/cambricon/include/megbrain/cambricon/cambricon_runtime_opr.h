...
MGB_DEFINE_OPR_CLASS(
        CambriconRuntimeOpr, cg::SingleCNOutshapePureByInshapeOprBase) // {
public:
    ...
    bool is_tensor_dim_mutable() const { return m_tensor_dim_mutable; }

    static SymbolVarArray make(
            SharedBuffer buf, std::string symbol, const SymbolVarArray& src,
            bool tensor_dim_mutable = false, const OperatorNodeConfig& config = {});
