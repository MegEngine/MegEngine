...
MGB_DEFINE_OPR_CLASS(StaticInferSrcValueInjector, cg::SingleCNOperatorNodeBase) // {
...
MGB_DEFINE_OPR_CLASS(StaticInferMidValueInjector, cg::SingleCNOperatorNodeBase) // {
