...
std::vector<TestArg> get_int8_nchw4_small_channel_args_check_bounds(size_t kernel_size);
...
std::vector<TestArg> get_int8_chwn4_small_channel_args_check_bounds(size_t kernel_size);
...
std::vector<TestArg> get_int8_nchw44_args(
        size_t kernel_size, size_t pack_size, bool compute_float32 = false,
...
void check_conv_bias(
        std::vector<megdnn::test::conv_bias::TestArg> args, megdnn::Handle* handle,
...
#define FULL_NLMODE                                                                 \
    {                                                                               \
        param::ConvBias::NonlineMode::IDENTITY, param::ConvBias::NonlineMode::RELU, \
