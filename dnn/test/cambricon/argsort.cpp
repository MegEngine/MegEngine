...
TEST_F(CAMBRICON, ARGSORT_FORWARD_F32) {
    run_forward_test(handle_cambricon(), dtype::Float32{});
}

TEST_F(CAMBRICON, ARGSORT_FORWARD_I32) {
    run_forward_test(handle_cambricon(), dtype::Int32{});
}

TEST_F(CAMBRICON, ARGSORT_BACKWARD_F32) {
    run_backward_test(handle_cambricon(), dtype::Float32{});
}

TEST_F(CAMBRICON, ARGSORT_BACKWARD_I32) {
    run_backward_test(handle_cambricon(), dtype::Int32{});
}
