...
TEST_F(CUDA, GROUP_CONVOLUTION3D_FORWARD_1x1x1) {
    auto run = [&](size_t N, size_t IC, size_t ID, size_t IH, size_t IW, size_t FD,
        ...
        checker.set_before_exec_callback(AlgoChecker<Convolution3DForward>(
                ExecutionPolicyAlgoName{"CUDA:GROUP_CONV3D_FORWARD", {{"1x1x1", {}}}}));
        Convolution3D::Param param;
        param.sparse = Convolution3D::Param::Sparse::GROUP;
        auto ICg = IC / group;
        auto OCg = OC / group;
...
TEST_F(CUDA, GROUP_CONVOLUTION3D_BACKWARD_DATA) {
    auto run = [&](size_t N, size_t IC, size_t ID, size_t IH, size_t IW, size_t FD,
                   size_t FH, size_t FW, size_t OC, size_t OD, size_t OH, size_t OW,
                   size_t PD, size_t PH, size_t PW, size_t SD, size_t SH, size_t SW,
                   size_t group) {
...
TEST_F(CUDA, GROUP_CONVOLUTION3D_BACKWARD_FILTER_CUDNN) {
    auto run = [&](size_t N, size_t IC, size_t ID, size_t IH, size_t IW, size_t FD,
        ...
        Checker<Convolution3DBackwardFilter> checker(handle_cuda());
        checker.set_before_exec_callback(
                AlgoChecker<Convolution3DBackwardFilter>(ExecutionPolicyAlgoName{
                        "CUDA:GROUP_CONV3D_BACKWARD_FILTER", {{"CUDNN", {}}}}));
        Convolution3DBackwardFilter::Param param;
        param.sparse = Convolution3D::Param::Sparse::GROUP;
        param.pad_d = PD;
        param.pad_h = PH;
