...
void gemm_u8_4x8_nobias_identity::pack_A(
...
void gemm_u8_4x8_nobias_identity::pack_B(
...
KERN(4, 8, bias_channel, BiasMode::BROADCAST_CHANNEL_BIAS, hswish, FuseAddHSwishOp)
#undef DEFINE_OP
