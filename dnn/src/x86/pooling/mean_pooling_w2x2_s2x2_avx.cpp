...
#undef CALCULATE2
    ...
    for (idst_h = dst_h_beg; idst_h + 4 <= dst_h_end; idst_h += 4) {
        ...
        for (idst_w = dst_w_beg; idst_w + 8 <= dst_w_end; idst_w += 8) {
            ...
            __m256 va0, vb0, vc0, vd0, va1, vb1, vc1, vd1, va2, vb2, vc2, vd2, va3, vb3,
                    vc3, vd3;

            va0 = _mm256_loadu2_m128_emulate(
                    src_dd + 0 * src_w + 8, src_dd + 0 * src_w);
            vb0 = _mm256_loadu2_m128_emulate(
                    src_dd + 0 * src_w + 12, src_dd + 0 * src_w + 4);
            vc0 = _mm256_loadu2_m128_emulate(
                    src_dd + 1 * src_w + 8, src_dd + 1 * src_w);
            vd0 = _mm256_loadu2_m128_emulate(
                    src_dd + 1 * src_w + 12, src_dd + 1 * src_w + 4);
            va1 = _mm256_loadu2_m128_emulate(
                    src_dd + 2 * src_w + 8, src_dd + 2 * src_w);
            vb1 = _mm256_loadu2_m128_emulate(
                    src_dd + 2 * src_w + 12, src_dd + 2 * src_w + 4);
            vc1 = _mm256_loadu2_m128_emulate(
                    src_dd + 3 * src_w + 8, src_dd + 3 * src_w);
            vd1 = _mm256_loadu2_m128_emulate(
                    src_dd + 3 * src_w + 12, src_dd + 3 * src_w + 4);
            va2 = _mm256_loadu2_m128_emulate(
                    src_dd + 4 * src_w + 8, src_dd + 4 * src_w);
            vb2 = _mm256_loadu2_m128_emulate(
                    src_dd + 4 * src_w + 12, src_dd + 4 * src_w + 4);
            vc2 = _mm256_loadu2_m128_emulate(
                    src_dd + 5 * src_w + 8, src_dd + 5 * src_w);
            vd2 = _mm256_loadu2_m128_emulate(
                    src_dd + 5 * src_w + 12, src_dd + 5 * src_w + 4);
            va3 = _mm256_loadu2_m128_emulate(
                    src_dd + 6 * src_w + 8, src_dd + 6 * src_w);
            vb3 = _mm256_loadu2_m128_emulate(
                    src_dd + 6 * src_w + 12, src_dd + 6 * src_w + 4);
            vc3 = _mm256_loadu2_m128_emulate(
                    src_dd + 7 * src_w + 8, src_dd + 7 * src_w);
            vd3 = _mm256_loadu2_m128_emulate(
                    src_dd + 7 * src_w + 12, src_dd + 7 * src_w + 4);
    ...
    if (idst_h + 2 <= dst_h_end) {
        ...
        for (idst_w = dst_w_beg; idst_w + 8 <= dst_w_end; idst_w += 8) {
            ...
            __m256 va0, vb0, vc0, vd0, va1, vb1, vc1, vd1;
