...
#define cb(                                                                            \
        _ctype, _simd_ptr_type, _simd_target, _src_ptr_ctype, _simd_type, _fun_prefix, \
        _fun_suffix1, _fun_suffix2, simd_type)                                         \
    template <>                                                                        \
...
cb(dt_qint32, __m128i, "sse4.2", int, __m128i, mm, si128, epi32, SIMDType::SSE4_2);
cb(dt_qint8, __m128i, "sse4.2", int8_t, __m128i, mm, si128, epi8, SIMDType::SSE4_2);
cb(dt_quint8, __m128i, "sse4.2", uint8_t, __m128i, mm, si128, epi8, SIMDType::SSE4_2);
cb(dt_int32, __m128i, "sse4.2", int32_t, __m128i, mm, si128, epi32, SIMDType::SSE4_2);
cb(dt_int16, __m128i, "sse4.2", short, __m128i, mm, si128, epi16, SIMDType::SSE4_2);
cb(dt_int8, __m128i, "sse4.2", int8_t, __m128i, mm, si128, epi8, SIMDType::SSE4_2);
cb(dt_uint8, __m128i, "sse4.2", uint8_t, __m128i, mm, si128, epi8, SIMDType::SSE4_2);
cb(dt_float32, float, "sse4.2", float, __m128, mm, ps, ps, SIMDType::SSE4_2);

cb(dt_qint32, __m256i, "avx2", int, __m256i, mm256, si256, epi32, SIMDType::AVX2);
cb(dt_qint8, __m256i, "avx2", int8_t, __m256i, mm256, si256, epi8, SIMDType::AVX2);
cb(dt_quint8, __m256i, "avx2", uint8_t, __m256i, mm256, si256, epi8, SIMDType::AVX2);
cb(dt_int32, __m256i, "avx2", int, __m256i, mm256, si256, epi32, SIMDType::AVX2);
cb(dt_int16, __m256i, "avx2", short, __m256i, mm256, si256, epi16, SIMDType::AVX2);
cb(dt_int8, __m256i, "avx2", int8_t, __m256i, mm256, si256, epi8, SIMDType::AVX2);
...
#define OP_CALLER(simd_type, target_simd)                                         \
    ...
    struct OpCallerBinary<Op, simd_type, VEC_VEC> {                               \
        MEGDNN_ATTRIBUTE_TARGET(target_simd)                                      \
        static void run(                                                          \
                const typename Op::src_ctype* src0,                               \
                const typename Op::src_ctype* src1, typename Op::dst_ctype* dst,  \
                DType src0_dtype, DType src1_dtype, DType dst_dtype,              \
                size_t nr_elems) {                                                \
...
#define OP_CALLER(simd_type, target_simd)                                          \
    ...
    struct OpCallerBinary<Op, simd_type, VEC_BCAST101> {                           \
        ...
        static void run(                                                           \
                const typename Op::src_ctype* src0,                                \
                const typename Op::src_ctype* src1, typename Op::dst_ctype* dst,   \
                DType src0_dtype, DType src1_dtype, DType dst_dtype, size_t batch, \
...
#define OP_CALLER(simd_type, target_simd)                                              \
    ...
    struct OpCallerTernary<Op, simd_type, VEC_VEC_SCALAR> {                            \
        ...
        static void run(                                                               \
                ...
                typename Op::dst_ctype* dst, DType src0_dtype, DType src1_dtype,       \
                DType src2_dtype, DType dst_dtype, size_t nr_elems) {                  \
            Op op(src0_dtype, src1_dtype, src2_dtype, dst_dtype);                      \
            ParamElemVisitor<typename Op::src_ctype, simd_type> vis0;                  \
            ParamElemVisitor<typename Op::src_ctype, simd_type> vis1;                  \
