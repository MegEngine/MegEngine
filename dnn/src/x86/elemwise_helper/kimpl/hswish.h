...
#define OP(                                                                            \
    ...
    struct HSwishOp<_simd_type, _ctype> : HSwishOpBase<_simd_type, _ctype> {           \
        ...
        _simd_data_type2 operator()(const _simd_data_type2& src) const {               \
            _simd_data_type val_0 = _##_func_prefix##_set1_##_func_suffix(0.0f);       \
            _simd_data_type val_6 = _##_func_prefix##_set1_##_func_suffix(6.0f);       \
            _simd_data_type val_3 = _##_func_prefix##_set1_##_func_suffix(3.0f);       \
            _simd_data_type val_1_6 = _##_func_prefix##_set1_##_func_suffix(1.0f / 6); \
            auto vitem0 = _##_func_prefix##_add_##_func_suffix(src.val[0], val_3);     \
            auto vitem1 = _##_func_prefix##_add_##_func_suffix(src.val[1], val_3);     \
