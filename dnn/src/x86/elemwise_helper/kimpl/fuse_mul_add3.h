...
#define OP(                                                                            \
    ...
    template <>                                                                        \
    struct FuseMulAdd3Op<_simd_type, _ctype> : FuseMulAdd3OpBase<_simd_type, _ctype> { \
        ...
        _simd_data_type2 operator()(                                                   \
            ...
            auto vitem0 =                                                              \
                    _##_func_prefix##_mul_##_func_suffix1(src0.val[0], src1.val[0]);   \
            vitem0 = _##_func_prefix##_add_##_func_suffix1(src2.val[0], vitem0);       \
            auto vitem1 =                                                              \
                    _##_func_prefix##_mul_##_func_suffix1(src0.val[1], src1.val[1]);   \
            vitem1 = _##_func_prefix##_add_##_func_suffix1(src2.val[1], vitem1);       \
            return {{vitem0, vitem1}};                                                 \
        }                                                                              \
        MEGDNN_ATTRIBUTE_TARGET(_simd_target)                                          \
        _simd_data_type operator()(                                                    \
                const _simd_data_type& src0, const _simd_data_type& src1,              \
