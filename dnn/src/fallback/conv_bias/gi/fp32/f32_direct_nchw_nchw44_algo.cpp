...
static inline void copy_pad_src(
        float* sptr_base, const float* sptr_origin, int ph, int pw, int pad_right,
...
static void pack_weight(
    ...
    fp32_direct_nchw_nchw44::pack_weight_fp32_nchw_nchw44(
...
static void do_conv_kern(
    ...
    const float* bptr = kern_param.bias<dt_float32>(batch_id, group_id) + oc_idx;
    Op op;

    fp32_direct_nchw_nchw44::conv_direct_fp32_nchw_nchw44<
...
SmallVector<ConvBiasImpl::NCBKern> ConvBiasImpl::AlgoF32DirectNCHWNCHW44::
