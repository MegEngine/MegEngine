/**
 * \file dnn/src/arm_common/convolution/quint8/conv_backdata_stride2.h
...
bool can_stride2_quint8_dot(const NCBKernSizeParam& param);

void stride2_quint8_dot(const NCBKernParam& param);
