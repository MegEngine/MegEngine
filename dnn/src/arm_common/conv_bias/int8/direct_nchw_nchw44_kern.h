...
template <int stride>
void pack_nchw_src_for_nchw44_conv(
        ...
        const int iw, const int iw2, const int pw, int8_t* temp_ptr);

template <int stride>
void pack_nchw44_weight_for_nchw_conv(
...
template <BiasMode bias_mode, typename Op, size_t filter_size, int stride>
static void conv_direct_int8_nchw_nchw44(
        const int8_t* src, const int8_t* filter, const int32_t* bias, int32_t* temp,
        int8_t* dst, const size_t oc, const size_t ic, const size_t ih, const size_t iw,
