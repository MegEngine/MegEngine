/**
 * \file dnn/src/arm_common/conv_bias/int8/stride2_dotprod.cpp
...
using namespace direct_dotprod_int8_stride2;
...
bool direct_dotprod_int8_stride2::can_conv_direct_stride2_int8(
...
WorkspaceBundle direct_dotprod_int8_stride2::get_bundle(
...
#define KERN0_NEED_POST_PROCESS(filter, first_ic, last_ic)          \
    conv_bias::conv_direct_stride2_##filter##x##filter##_int8_dot<  \
...
SmallVector<ConvBiasImpl::NCBKern> direct_dotprod_int8_stride2::get_kimpls(
