/**
 * \file dnn/src/arm_common/conv_bias/int8/stride2.cpp
...
using namespace direct_int8_stride2;
...
bool direct_int8_stride2::can_conv_direct_stride2_int8(const NCBKernSizeParam& param) {
    auto&& fm = param.filter_meta;
...
WorkspaceBundle direct_int8_stride2::get_bundle(
...
void direct_int8_stride2::do_conv_kern(
...
#define KERN0_NEED_POST_PROCESS(filter, first_ic, last_ic)          \
    conv_bias::conv_direct_stride2_##filter##x##filter##_int8_nchw< \
...
SmallVector<ConvBiasImpl::NCBKern> direct_int8_stride2::get_kimpls(
