...
bool direct_int8_stride1::can_conv_direct_stride1_int8(
...
void direct_int8_stride1::do_conv_kern(const WorkspaceBundle& bundle,
    ...
    void* dst = reinterpret_cast<void*>(reinterpret_cast<ptrdiff_t>(
            kern_param.dst<void>(batch_id, group_id, oc)));
