/**
 * \file dnn/src/arm_common/conv_bias/quint8/stride1_dotprod.cpp
...
using namespace direct_dotprod_quint8_stride1;
...
bool direct_dotprod_quint8_stride1::can_conv_direct_stride1_quint8(
...
WorkspaceBundle direct_dotprod_quint8_stride1::get_bundle(
...
#define KERN0_NEED_POST_PROCESS(filter, first_ic, last_ic)                      \
    conv_bias::conv_direct_stride1_##filter##x##filter##_quint8_dot<            \
...
SmallVector<ConvBiasImpl::NCBKern> direct_dotprod_quint8_stride1::get_kimpls(
