/**
 * \file dnn/src/arm_common/conv_bias/quint8/direct_dotprod.h
...
#define KERN(stride, i)                                                     \
    template <bool first_ic, bool last_ic, bool fused_kern,                 \
              BiasMode bias_mode, typename Op>                              \
    void conv_direct_##stride##_##i##x##i##_quint8_dot(                     \
            ...
            const uint8_t filter_zp, const int32_t src_filter_zp,           \
            const Op& op);
