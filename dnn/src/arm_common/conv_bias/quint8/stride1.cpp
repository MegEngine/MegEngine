/**
 * \file dnn/src/arm_common/conv_bias/quint8/stride1.cpp
...
using namespace direct_quint8_stride1;
...
bool direct_quint8_stride1::can_conv_direct_stride1_quint8(
...
WorkspaceBundle direct_quint8_stride1::get_bundle(
...
void direct_quint8_stride1::copy_padding_kern(
...
void direct_quint8_stride1::do_conv_kern(
...
#define SUB128(n) static_cast<int8_t>(static_cast<int32_t>(n) - 128)
    uint8_t _src_zp = kern_param.src_type.param<dtype::Quantized8Asymm>().zero_point;
    int8_t src_zp = SUB128(_src_zp);
    int8_t filter_zp =
            SUB128(kern_param.filter_type.param<dtype::Quantized8Asymm>().zero_point);
...
#define KERN0_NEED_POST_PROCESS(filter, first_ic, last_ic)                      \
    conv_bias::conv_direct_stride1_##filter##x##filter##_quint8<                \
...
SmallVector<ConvBiasImpl::NCBKern> direct_quint8_stride1::get_kimpls(
