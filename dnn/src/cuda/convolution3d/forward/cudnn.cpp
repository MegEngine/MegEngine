...
bool Convolution3DForwardImpl::AlgoCUDNN::is_available(const SizeArgs& args) const {
    CUDNNForwardDescs D;
    ...
    auto status = cudnnGetConvolutionForwardWorkspaceSize(
            ...
            D.conv_desc.desc, D.dst_desc.desc, m_cudnn_enum, &workspace_size);
...
void Convolution3DForwardImpl::AlgoCUDNN::exec(const ExecArgs& args) const {
    CUDNNForwardDescs D;
    args.init_desc(D);
