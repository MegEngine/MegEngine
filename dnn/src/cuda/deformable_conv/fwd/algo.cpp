...
OprImpl::AlgoBase::ExecArgs::ExecArgs(
        ...
        _megdnn_tensor_in offset, _megdnn_tensor_in mask, _megdnn_tensor_out dst,
...
std::string OprImpl::AlgoBase::SizeArgs::to_string() const {
    ...
    return ssprintf(
            ...
            im_layout.to_string().c_str(), fm.group, fm.ocpg, fm.icpg, fm.spatial[0],
            fm.spatial[1], offset_layout.to_string().c_str(),
